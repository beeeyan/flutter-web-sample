...
// id
  ...
  String? get name => throw _privateConstructorUsedError; // 作成日
  @DatetimeConverter()
...
// 更新日
  ...
  @override
  String toString() {
    return 'Post(id: $id, name: $name, createdAt: $createdAt, updatedAt: $updatedAt)';
  }
...
abstract class _Post implements Post {
  const factory _Post(
      ...
      @DatetimeConverter() final DateTime? updatedAt}) = _$_Post;
